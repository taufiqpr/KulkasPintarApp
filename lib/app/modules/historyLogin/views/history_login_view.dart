...
import 'login_history_chart_view.dart'; // <- pastikan import halaman grafik
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return Column(
          children: [
            // Section Header dengan tombol di kanan
            Padding(
              ...
              child: Row(
                ...
                children: [
                  TextButton.icon(
                    onPressed: () {
                      Get.to(() => const LoginHistoryChartView());
                    },
            ...
            // Konten utama
            Expanded(child: _buildLoginHistoryBody()),
          ],
        );
      }),
    );
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildHistoryCard(item, isSuccess);
        },
      ),
    );
  }

  Widget _buildHistoryCard(Map<String, dynamic> item, bool isSuccess) {
    return Container(
